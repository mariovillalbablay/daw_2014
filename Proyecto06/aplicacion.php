...
<body>
	...
	$db= new db("localhost","root","mariete13","Tarea18");
		...
		//Si existe una variable get esque el usuario a pulsado en un ID por lo que se mostrara un formulario con dicha informacion
		if (isset($_GET["lugar"])){
		...
		//Si no hay variable GET se mostraran todos los lugares	
		}else{
			$db->conectar_base_datos();
			
			//En caso de que hayan variables post esque el usuario ha modificado los datos por lo que se llamara a la funcion que realiza el update en la bd
